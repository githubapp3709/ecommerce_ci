                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-4">
                                    ...
                                    <p class="text-muted mb-0 text-truncate">
                                        <span class="badge bg-subtle-success text-success font-size-12 fw-normal me-1"><i class="mdi mdi-arrow-top-right"></i> 2.8%
                                            Increase</span>
                                        vs last month
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-4">
                                    ...
                                    <p class="text-muted mb-0 text-truncate">
                                        <span class="badge bg-subtle-danger text-danger font-size-12 fw-normal me-1"><i class="mdi mdi-arrow-bottom-left"></i> 7.8%
                                            Loss</span>
                                        vs last month
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-4">
                                    ...
                                    <p class="text-muted mb-0 text-truncate">
                                        <span class="badge bg-subtle-success text-success font-size-12 fw-normal me-1"><i class="mdi mdi-arrow-top-right"></i> 4.6%
                                            Growth</span>
                                        vs last month
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-4">
                                    ...
                                    <p class="text-muted mb-0 text-truncate">
                                        <span class="badge bg-subtle-success text-success font-size-12 fw-normal me-1"><i class="mdi mdi-arrow-top-right"></i> 23%
                                            Increase</span>
                                        vs last month
                                    </p>
                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mt-4">
                                                <div class="progress" style="height: 7px">
                                                    <div class="progress-bar bg-primary" role="progressbar" style="width: 85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="85"></div>
                                                </div>
                                        ...
                                        <table class="table align-middle table-centered table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>2,123</td>
                                                    <td>
                                                        <span class="badge bg-subtle-primary text-primary font-size-11 ms-1"><i class="mdi mdi-arrow-up"></i>
                                                            45.3%</span>
                                                    </td>
                                                </tr>
                                                <!-- end -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>3,652</td>
                                                    <td>
                                                        <span class="badge bg-subtle-danger text-danger font-size-11 ms-1"><i class="mdi mdi-arrow-down"></i>
                                                            14.6%</span>
                                                    </td>
                                                </tr>
                                                <!-- end -->
                                ...
                                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-muted">
                                                <i class="mdi mdi-trending-up text-success font-size-18 align-middle me-1"></i>$250.00
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/avatar-5.jpg" class="avatar-sm rounded-circle" alt="..." />
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-muted">
                                                <i class="mdi mdi-trending-down text-danger font-size-18 align-middle me-1"></i>$110.00
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-muted">
                                                <i class="mdi mdi-trending-up text-success font-size-18 align-middle me-1"></i>$420.00
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-muted">
                                                <i class="mdi mdi-trending-down text-danger font-size-18 align-middle me-1"></i>$120.00
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/avatar-8.jpg" class="avatar-sm rounded-circle" alt="..." />
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-muted">
                                                <i class="mdi mdi-trending-up text-success font-size-18 align-middle me-1"></i>$112.00
                                            </td>
                                            <td>
                                                <span class="badge badge-soft-info font-size-12">Active</span>
                                            </td>
                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/avatar-2.jpg" class="avatar-xs rounded-circle me-2" alt="..." />
                                                Neal Matthews
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/avatar-3.jpg" class="avatar-xs rounded-circle me-2" alt="..." />
                                                Jamal Burnett
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/avatar-4.jpg" class="avatar-xs rounded-circle me-2" alt="..." />
                                                Juan Mitchell
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/avatar-5.jpg" class="avatar-xs rounded-circle me-2" alt="..." />
                                                Barry Dick
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/avatar-6.jpg" class="avatar-xs rounded-circle me-2" alt="..." />
                                                Ronald Taylor
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="assets/images/users/avatar-7.jpg" class="avatar-xs rounded-circle me-2" alt="..." />
                                                Jacob Hunter
                                            </td>
                                            <td>
