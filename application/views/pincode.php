                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="pincode" placeholder="Category Name" name="pincode">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="deliver_charge" placeholder="Category Name" name="deliver_charge">
                                            <label for="deliver_charge">Delivery charges</label>
                                        </div>
